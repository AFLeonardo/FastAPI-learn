...
SECRET = "afa506896f78d7c169d09ad3ebade131e84b516968657a0bea130e7f64f4d023"
...
users_db = {
    "Valeria": {
        ...
        "disable": False,
        "password": "$2a$04$FpdNRIyZRQBctAFrvgsgLez.pkp6sDMzTr0BXlBzoXKTxu4ZXjEOC" # <- In a real app, passwords should be hashed
    },
    "Carlos": {
        "username": "Carlos",
        ...
        "disable": True,
        "password": "$2a$04$RmkxWbvcZkpW1QbgQdjzGOly30JXpNQsRjaTqpTTekOQGFu0.vInS"
    }
}
